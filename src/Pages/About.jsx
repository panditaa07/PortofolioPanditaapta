        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Saya Pandita, seorang pelajar SMK jurusan Rekayasa Perangkat Lunak (RPL) dengan semangat tinggi di bidang pemrograman. Setiap proyek bagi saya adalah kesempatan untuk belajar, berkembang, dan menghadirkan solusi kreatif dengan karakter serta desain yang kuat.
            </p>
